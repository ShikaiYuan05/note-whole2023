...
<img src="images/1684889792508.png" alt="1684889792508" style="zoom: 60%;" />
...
![1683883635074](images/1683883635074.png)
...
>  MVC（Model View Controller）是软件工程中的一种软件架构模式，它把软件系统分为模型、**视图**和**控制器**三个基本部分。用一种业务逻辑、数据、界面显示分离的方法组织代码，将业务逻辑聚集到一个部件里面，在改进和个性化定制界面及用户交互的同时，不需要重新编写业务逻辑。**`简单来说MVC就是一套追求代码"高内聚,低耦合"的一套代码编写理论体系`**
...
<img src="images/login.gif" alt="login" style="zoom: 60%;" />
